...
import 'package:mobile/page/listtransaction/salesdetail.dart';
...
class _ListingTransactionState extends State<ListingTransaction> {
  ...
  Future initFutureList() async {
    // Fetch data
    paginateData = await ServiceController.fetchTransaction(paginateData);
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  padding:
                                      ...
                                      decoration: BoxDecoration(border:Border.symmetric(horizontal: BorderSide(color: Colors.grey.shade100,),),color: Colors.white,),
